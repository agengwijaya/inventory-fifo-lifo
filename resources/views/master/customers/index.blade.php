...
@section('content')
      ...
      <div class="content__wrap">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="#">Data Customers</a></li>
          </ol>
        </nav>
      </div>
    </div>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row row-cols-auto justify-content-between mb-3">
                    <div class="col">
                      <h5 class="card-title">List Data Customers</h5>
                    </div>
                    <div class="col">
                      <div class="form-group">
                        <button type="button" class="btn btn-primary form-control" data-bs-toggle="modal" data-bs-target="#modalAddCustomer"><i class="fa fa-plus"></i> Tambah Customer</button>
                      </div>
                    </div>
                  </div>
                  <div class="row">
      ...
      <div class="modal-content">
        <form action="{{ url('data-master/data-customers') }}" method="POST">
          ...
          <div class="modal-header">
            <h5 class="modal-title" id="modalAddCustomerLabel">Form Tambah Data Customers</h5>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <form method="POST" id="form_edit">
          ...
          @csrf
          <div class="modal-header">
            <h5 class="modal-title" id="modalEditLabel">Edit Data Customers</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="row">
  ...
  <script>
    $('#transaksi').on('click', 'tbody td #btn_edit', function() {
      ...
      $('#form_edit').attr('action', "{{ url('data-master/data-customers/') }}" + '/' + data.id);
    ...
    $('#transaksi').on('click', 'tbody td #btn_delete', function() {
      ...
      $('#form_delete').attr('action', "{{ url('data-master/data-customers/') }}" + '/' + id);
    })
